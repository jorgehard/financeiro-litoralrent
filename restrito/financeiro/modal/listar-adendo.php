...
<?php
		echo '<div class="box box-warning">
			...
			while($s = $stm->fetch())
			{
				...
				if($s['tipo_adendo'] == '0' && $s['tipo'] == '0') {
					echo '<a href="#" onclick=\'$(".modal-body").load("financeiro/del/excluir-contrato-item.php?&id='.$s['id'].'&equipamento='.$s['equipamento'].'&id_contrato='.$id_contrato.'")\' data-toggle="modal" data-target="#myModal2"  class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span></a>';
				}else{
