...
$(document).ready(function () {
	...
	<div class="container-fluid" id="alert1" style="margin:0px; padding:0px;">
		<h2 style="font-family: 'Oswald', sans-serif; letter-spacing:1px;"><small>  Cadastrar novo Adendo</small>
		</h2>
	</div>
	<div class="box box-widget box-fix-layout" style=" background:#e1f7f3">
		<div class="container-fluid" style="padding:5px">
			<form action="javascript:void(0)" onSubmit="post(this,'financeiro/modal/cadastrar-adendo.php?ac=criarAdendo&id_contrato=<?php echo $id_contrato ?>','.cadastroAdendo')">
				<div class="box-body">
	...
	<div class="listarAdendo">
		<script>ldy("financeiro/modal/adendo-itens.php?id_contrato=<?php echo $id_contrato ?>",".listarAdendo")</script>
	</div>
