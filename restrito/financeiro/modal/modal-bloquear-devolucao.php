<?php
	...
	echo '
		<div class="ajax">
			<center>
			<a href="javascript:void(0)" class="btn btn-success btn-sm" style="width:150px; margin-right:20px;" onclick=\'ldy("financeiro/modal/modal-bloquear-devolucao.php?ac='.$tipo.'&id_adendo='.$id_adendo.'&id_contrato='.$id_contrato.'",".ajax")\'>Sim</a>
