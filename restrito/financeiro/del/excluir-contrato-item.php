<?php
	...
	if(isset($ac)){
		if($ac=='excluir') { 
			...
			$inser = $con->query("UPDATE notas_equipamentos SET controle = '0' WHERE id = '$equipamento'");
	...
	echo '
		<div class="ajax">
			<center>
			<a href="javascript:void(0)" class="btn btn-success btn-sm" style="width:150px; margin-right:20px;" onclick=\'ldy("financeiro/del/excluir-contrato-item.php?ac=excluir&id='.$id.'&equipamento='.$equipamento.'&id_contrato='.$id_contrato.'",".ajax")\'>Sim</a>
